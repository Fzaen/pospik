...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategoryEntity = new EntityInsertionAdapter<CategoryEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`cat_id`,`cat_name`,`cat_subname`) VALUES (nullif(?, 0),?,?)";
      }

      @Override
      protected void bind(@NonNull final SupportSQLiteStatement statement,
          @NonNull final CategoryEntity entity) {
        statement.bindLong(1, entity.getCatId());
        statement.bindString(2, entity.getCatName());
        statement.bindString(3, entity.getCatSubname());
      }
    };
    this.__updateAdapterOfCategoryEntity = new EntityDeletionOrUpdateAdapter<CategoryEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `categories` SET `cat_id` = ?,`cat_name` = ?,`cat_subname` = ? WHERE `cat_id` = ?";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(2, entity.getCatName());
        statement.bindString(3, entity.getCatSubname());
        statement.bindLong(4, entity.getCatId());
      }
    };
    this.__preparedStmtOfDeleteCategory = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM categories WHERE cat_id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object deleteCategory(final int catId, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        ...
        int _argIndex = 1;
        _stmt.bindLong(_argIndex, catId);
        try {
          __db.beginTransaction();
          try {
  ...
  public Flow<List<CategoryEntity>> getAllCategories() {
    final String _sql = "SELECT * FROM categories ORDER BY cat_name ASC";
      ...
      public List<CategoryEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final int _tmpCatId;
            _tmpCatId = _cursor.getInt(_cursorIndexOfCatId);
            ...
            _item = new CategoryEntity(_tmpCatId,_tmpCatName,_tmpCatSubname);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getMainCategories(final Continuation<? super List<String>> $completion) {
    final String _sql = "SELECT DISTINCT cat_name FROM categories";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  @Override
  public Object getProductCountByCategory(final int catId,
      final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM products WHERE prd_category_id = ?";
